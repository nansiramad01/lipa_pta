    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/tambahusers">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Level')
                                }}</label>

                            <div class="col-md-6">
                                <select id="level" class="form-control" class="form-select" name="level" id="level">
                                    {{-- <select class="form-select" aria-label="Default select example"> --}}
                                        <option selected>--pilih level--</option>
                                        <option value="adminsatker">adminsatker</option>
                                        <option value="adminpta">adminpta</option>
                                        <option value="pejabatpta">pejabatpta</option>
                                    </select>

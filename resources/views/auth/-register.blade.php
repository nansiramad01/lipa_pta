                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="level" id="level" class="form-control">
                                ...
                                <option value="adminsatkekr">Admin Satker</option>
                                <option value="adminpta">Admin PTA</option>
                                <option value="pejabatpta">Pejabat PTA</option>
                            </select>
                        </div>

                        <div class="col-md-6">
                            <label for="satuankerja" class="form-label">satuankerja</label>
                            <select name="satuankerja" id="satuankerja" class="form-control">
                                <option {{ satuankerja()->id_satker }}> </option>
                                {{-- <option value="adminsatkekr">Admin Satker</option>
                                <option value="adminpta">Admin PTA</option>
                                <option value="pejabatpta">Pejabat PTA</option> --}}
                            </select>
                        ...
                        {{-- <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" {{ auth()->satuankerja()->id_satker }} " required autocomplete="email">
